...
void Shader::createShader(std::string fileName)
{
    ...
    if (!success)
    {
        ...
        std::clog << "Vertex Shader Compile Error. " << infoLog << std::endl;
    }
    ...
    if (!success)
    {
        ...
        std::clog << "Fragment Shader Compile Error. " << infoLog << std::endl;
    }
    ...
    if (!success)
    {
        ...
        std::clog << "Program Link Error. " << infoLog << std::endl;
    }
